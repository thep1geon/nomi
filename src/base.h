...
/* Macros to make working with macros easier */
...
#ifdef ENABLE_ASSERT
#   define ASSERT(e) STATEMENT( if (!(e)) { fprintf(stderr, "%s:%d: %s: assertion `%s' failed\n", _FILE, _LINE, _FUNC, #e); exit(1); } )
#else
#   define ASSERT(e)
#endif

/* Math related thingys */
...
#endif /* DATA_STRUCTURES_IMPLEMENTATION */
